      ...
      <ul style={{ listStyle: 'none', padding: '0', width: '100%', display: 'flex', justifyContent: 'center',flexWrap: 'wrap' }}>
        {invoice.items.map((item, index) => (
          ...
          <li key={item.id} style={{ display: 'flex', alignItems: 'center', marginBottom: '10px', justifyContent: 'center' }}>
            ...
            <input type="number" placeholder="Quantity"  onChange={(e) => handleInputChange(e, index, "quantity")} min="1"  style={{ width: '80px', marginRight: '10px', backgroundColor: '#f8f9fa', borderRadius: '5px',height: '30px',width: '80px' }} />
